		...
		<div class="section">
			...
			<div id="input-fields">
				...
				<div class="row">
					<div class="col s12 m12 l12">
						<div class="row">
							{!! Form::model($user, ['route' => ['user-control.update', encrypt($user->id)], 'class' => 'col s12', 'id' => 'user_form', 'method' => 'PUT']) !!}
								<div class="row">
									<div class="input-field col s12">
										{!! Form::text('name', $user->name, ['id' => 'name', 'class' => 'validate', 'placeholder' => 'Nama Lengkap']) !!}
										<label for="name">Nama Lengkap</label>
									</div>
								</div>
								<div class="row">
									<div class="input-field col s12">
										{!! Form::email('email', $user->email, ['id' => 'email', 'class' => 'validate', 'placeholder' => 'Email']) !!}
